...
include '../header.php';
$id = $_GET['id'];
$query = "SELECT * FROM tb_kelas WHERE kd_kelas = '$id'";
         ...
         <div class="col-sm-6 mr-auto ml-auto pt-5">
            ...
            <form action="ubahproses.php" method="post">
                <div class="form-group">
                    ...
                    <input type="text" readonly="" class="form-control" value="<?= $d['kd_kelas'];?>" name="kd_kelas">
                </div>
                <div class="form-group">
                    <label>Nama Kelas : </label>
                    <input type="text" class="form-control" value="<?= $d['nm_kelas'];?>" name="nm_kelas">
                </div>
                 <div class="form-group">
                    <label>NIG : </label>
